...
export default function Locations() {
  return (
    <div className="max-w-[1111px] mx-auto relative overflow-hidden">
      <div className="flex flex-col gap-large md:gap-[120px] lg:mt-[60px] lg:gap-[42px] md:mt-[64px] md:px-standard">
        {locations.map((location, index) => {
          return (
            <div className="md:flex md:flex-col md:gap-[31px] lg:grid lg:grid-cols-3">
              ...
              <div className="py-[80px] px-small md:py-[96px] lg:w-full md:px-[75px] md:text-left md:min-h-[326px] min-h-[320px] bg-primary-light text-center flex flex-col justify-center text-dark-faded text-[15px] font-[400] leading-[25px] gap-standard md:rounded-standard">

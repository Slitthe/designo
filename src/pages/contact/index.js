...
export default function Contact() {
  ...
  return (
    <div className="lg:bg-leaf bg-no-repeat bg-right-bottom">
      <Head>
        <title>Designo - Contact</title>
      </Head>

      <div className="max-w-container mx-auto relative">
        <div className="bg-contactHeroMobile md:bg-contactHeroTablet md:bg-no-repeat md:bg-left md:rounded-standard md:mx-standard px-small md:px-[60px] md:mt-[60px] mb-[120px] py-[72px] lg:px-[96px] bg-primary-dark flex flex-col gap-[40px] lg:grid lg:grid-cols-2 lg:gap-[96px]">

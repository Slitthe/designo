...
function ProjectCard({ children, imgSrc }) {
  return (
    <div
      className="w-full h-full cursor-pointer before:hidden hover:before:block before:absolute before:inset-0 before:bg-primary-dark relative before:rounded-[15px] before:opacity-70 text-[28px] uppercase font-[500] flex items-center flex-col justify-center text-light rounded-[15px]"

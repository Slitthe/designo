...
function FooterCard() {
  return (
    <div className="mt-[121px] md:mt-[105px] lg:mt-[160px] mx-small px-small md:px-[58px] lg:p-0 lg:mx-standard bg-primary-dark rounded-standard h-[379px] md:h-[350px] lg:h-[292px] text-center flex flex-col align-center items-center lg:grid lg:grid-cols-2 bg-callToActionCircles bg-no-repeat bg-cover">

  ...
  return (
    <div
      className={`bg-heroCircle bg-[0 50%] bg-primary-dark md:mx-standard md:rounded-standard text-center md:mt-[60px] overflow-hidden${
        imageSrcset ? " lg:grid lg:grid-cols-5 lg:text-left" : ""
      }`}
    >
      {imageSrcset && (
        <div className="h-[325px] lg:order-1 lg:col-span-2 lg:h-full relative">
      ...
      <div className="md:mx-[70px] py-[80px] md:py-[64px] min-h-[325px] md:min-h[252px] flex flex-col align-center items-center justify-center px-small md:px-0 lg:col-span-3">
        <div
